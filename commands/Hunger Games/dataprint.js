...
var lp = wl();
  const hg1 = new discord.MessageEmbed()
  	...
  	.setTitle('Matchup')
  	.addFields(
  		{ name: 'District 1', value: data },
      {name: 'District 2', value:data2, inline:true},
      {name: 'District 3', value:data3, inline:true},
      {name: 'District 4', value: data5, inline:true},
      {name: 'District 5', value: data6, inline:true},
      {name: 'District 6', value: data7, inline:true},
      {name: 'District 7', value: data8, inline:true},
      {name: 'District 8', value: data9, inline:true},
      {name: 'District 9', value: data10, inline:true},
      {name: 'District 10', value: data11, inline:true},
      {name: 'Results', value:lp + data4, inline:true}
  	)
  	.setTimestamp()
